...
$stmt->execute([':id'=>$id]);
$data = $stmt->fetch();
if (!$data) { flash('error','Not found'); include __DIR__.'/movies.php'; return; }
?>
<div class="panel">
  <form method="post" enctype="multipart/form-data" action="?p=movie-update&id=<?= (int)$id ?>">
    ...
    <div style="display:flex; gap:10px; margin-top:8px;">
      ...
      <a class="btn" href="?p=movies">Cancel</a>
    </div>
  </form>
</div>